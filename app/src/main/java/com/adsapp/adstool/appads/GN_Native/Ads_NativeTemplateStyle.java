...
/** A class containing the optional styling options for the GN_Native Template. * */
public class Ads_NativeTemplateStyle {
  ...
  public static class Builder {
    ...
    public Builder() {
      this.styles = new Ads_NativeTemplateStyle();
    }
    ...
    public Ads_NativeTemplateStyle build() {
      return styles;
    }
  }
}

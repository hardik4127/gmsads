...
package com.adsapp.adstool.appads.GN_Native;
...
public class Ads_TemplateView extends FrameLayout {

  private int templateType;
  private Ads_NativeTemplateStyle styles;
  ...
  public Ads_TemplateView(Context context) {
    super(context);
  }

  public Ads_TemplateView(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context, attrs);
  }

  public Ads_TemplateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initView(context, attrs);
  }

  @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
  public Ads_TemplateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
    initView(context, attrs);
  }

  public void setStyles(Ads_NativeTemplateStyle styles) {
    this.styles = styles;
    this.applyStyles();
  }
  ...
  public String getTemplateTypeName() {
    if (templateType == R.layout.a_ads_m_templateview) {
      return MEDIUM_TEMPLATE;
    } else if (templateType == R.layout.a_ads_s_templateview) {
    ...
    try {
      templateType =
          attributes.getResourceId(
              R.styleable.TemplateView_gnt_template_type, R.layout.a_ads_m_templateview);
    } finally {
      attributes.recycle();
    }
